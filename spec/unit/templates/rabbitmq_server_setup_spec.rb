...
def cluster_partition_handling_with(policy)
  "SERVER_START_ARGS='-rabbit log_levels [{connection,info}] -rabbit disk_free_limit 50000000 -rabbit ' + "cluster_partition_handling #{policy} -rabbit halt_on_upgrade_failure false -rabbitmq_mqtt subscription_ttl 1800000"
end
